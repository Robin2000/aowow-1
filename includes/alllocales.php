...
switch($_SESSION['locale'])
{
	...
	case '8':
		mass_define(array(
			// objects
			'LOCALE_OBJECTYPE_BOOK' 		=> 'Книги',
			'LOCALE_OBJECTYPE_CONTAINER' 	=> 'Контейнеры',
			'LOCALE_OBJECTYPE_COFFER' 		=> 'Сундуки',
			'LOCALE_OBJECTYPE_HERB' 		=> 'Травы',
			'LOCALE_OBJECTYPE_ORE' 			=> 'Полезные Ископаемые',
			'LOCALE_OBJECTYPE_QUEST' 		=> 'Задание',
			// npc
			'LOCALE_NPCRANK_ELITE' 			=> '(Элита)',
			'LOCALE_NPCRANK_RAREELITE' 		=> '(Редкий Элитный)',
			'LOCALE_NPCRANK_BOSS' 			=> '(Босс)',
			'LOCALE_NPCRANK_RARE' 			=> '(Редкий)',
			'LOCALE_NPCTYPE_BEAST' 			=> 'Животное',
			'LOCALE_NPCTYPE_DRANGONKIN' 		=> 'Дракон',
			'LOCALE_NPCTYPE_DEMON' 			=> 'Демон',
			'LOCALE_NPCTYPE_ELEMENTAL' 		=> 'Элементаль',
			'LOCALE_NPCTYPE_GIANT' 			=> 'Великан',
			'LOCALE_NPCTYPE_UNDEAD' 		=> 'Нежить',
			'LOCALE_NPCTYPE_HUMANOID' 		=> 'Гуманоид',
			'LOCALE_NPCTYPE_CRITTER' 		=> 'Существо',
			'LOCALE_NPCTYPE_MECHANIC' 		=> 'Механизм',
			'LOCALE_NPCTYPE_UNCATEGORIZED' 	=> 'Неизвестный',
			// player/other
			'LOCALE_NAME'	=> 'имя',
			'LOCALE_CLASS'	=> 'класс',
			'LOCALE_RACE'	=> 'раса',
			...
			'LOCALE_QUEST_FLAGS_DELIVER_MORE'      => 'Используются доп. предметы',
			...
			'LOCALE_QUEST_FLAGS_REPEATABLE'        => 'Ежедневный PvP',
			'LOCALE_QUEST_FLAGS_UNAVAILABLE'       => 'Недоступен в игре',
			'LOCALE_QUEST_FLAGS_WEEKLY'            => 'Еженедельный',
			'LOCALE_QUEST_FLAGS_AUTOCOMPLETE'      => 'Автозавершение',
			'LOCALE_QUEST_FLAGS_SPECIAL_ITEM'      => 'Есть спец. предмет',
			'LOCALE_QUEST_FLAGS_OBJ_TEXT'          => 'Необычная задача',
			'LOCALE_QUEST_FLAGS_AUTO_ACCEPT'       => 'Стартовая локация',
			'LOCALE_QUEST_SPECIALFLAGS_REPEATABLE' => 'Повторяемый',
			'LOCALE_QUEST_SPECIALFLAGS_SCRIPTED'   => 'Завершается внешним скриптом/событием',
			'LOCALE_QUEST_SPECIALFLAGS_AUTO_ACCEPT'=> 'Берется автоматически',
			'LOCALE_QUEST_SPECIALFLAGS_DUNGEONFINDER'=> 'Поиск Подземелий',
			...
			'LOCALE_QUEST_TYPE_LIFE'               => 'Выживание',
			...
			// resistances
			'LOCALE_FIRE_RESISTANCE'	=>	'Сопротивление магии огня',
			'LOCALE_FROST_RESISTANCE'	=>	'Сопротивление магии льда',
			...
			'LOCALE_BIND_SOULBOUND'		=>	'Персональный предмет',
			'LOCALE_BIND_QUEST_ITEM'	=>	'Этот предмет позволяет получить задание',
			// bags
			'LOCALE_BAG'			=>	'Сумка',
			...
			'LOCALE_BAG_MINING'		=>	'Сумка шахтера',
			// equip slots
			...
			'LOCALE_DAMAGE_NATURE'	=>	'от сил природы',
			// stats
			...
			// green bonuses
			'LOCALE_GBONUS_DEFENCE'				=>	'Рейтинг защиты +%d.',
			'LOCALE_GBONUS_DODGE'				=>	'Рейтинг уклонения +%d.',
			'LOCALE_GBONUS_PARRY'				=>	'Рейтинг парирования +%d.',
			'LOCALE_GBONUS_SHIELDBLOCK'			=>	'Рейтинг блокирования +%d.',
			'LOCALE_GBONUS_SPELLHIT_RATING'		=>	'Рейтинг меткости заклинаний +%d.',
			'LOCALE_GBONUS_MELEECRIT_RATING'	=>	'Рейтинг критического удара в ближнем бою +%d.',		// eu armory uses this
			'LOCALE_GBONUS_RANGEDCRIT_RATING'	=>	'Рейтинг критического удара в дальнем бою +%d.',
			'LOCALE_GBONUS_SPELLCRIT_RATING'	=>	'Рейтинг критического удара заклинаний +%d.',
			'LOCALE_GBONUS_SPELLHASTE_RATING'	=>	'Рейтинг скорости заклинаний +%d.',
			'LOCALE_GBONUS_HIT_RATING'			=>	'Рейтинг меткости +%d.',
			'LOCALE_GBONUS_CRIT_RATING'			=>	'Рейтинг критического удара +%d.',
			'LOCALE_GBONUS_RESILIENCE_RATING'	=>	'Рейтинг устойчивости +%d.',
			'LOCALE_GBONUS_HASTE_RATING'		=>	'Рейтинг скорости +%d.',
			'LOCALE_GBONUS_EXPERTISE_RATING'	=>	'Рейтинг мастерства +%d.',
			'LOCALE_GBONUS_ARMORPENETRATION'	=>	'Рейтинг пробивания брони +%d.',
			'LOCALE_GBONUS_ATTACKPOWER'			=>	'Сила атаки +%d.',
			'LOCALE_GBONUS_SPELLPOWER'			=>	'Сила заклинаний +%d.',
			'LOCALE_GBONUS_RANGED_ATTACK_POWER' =>  'Сила атаки дальнего боя +%d.',
			'LOCALE_GBONUS_HASTE_MELEE_RATING' 	=>  'Рейтинг скорости в ближнем бою +%d.',
			'LOCALE_GBONUS_SPELLPENETRATION'	=>	'Увеличивает проникающую способность заклинаний на %d.',
			'LOCALE_GBONUS_HIT_TAKEN_MELEE_RATING'	=>  'Повышает шанс промаха в ближнем бою по вам на %d.',
			'LOCALE_GBONUS_HIT_TAKEN_SPELL_RATING'	=>  'Повышает шанс промаха заклинаний по вам на %d.',
			'LOCALE_GBONUS_RESTOREMANA'			=>	'Восстанавливает %d маны раз в 5 сек.',
			'LOCALE_GBONUS_RESTOREHEALTH'		=>	'Восстанавливает %d здоровья раз в 5 сек.',
			...
			'LOCALE_START_QUEST'	=>	'Этот предмет позволяет получить задание',
			'LOCALE_SLOT'			=>	' Ячейка ',
			'LOCALE_DPS'			=>	'Единиц урона в секунду',
			'LOCALE_DPS2'			=>	'урон в секунду',
			'LOCALE_DPS_ADDS'		=>	'Увеличивает',
			'LOCALE_ARMOR'			=>	'Броня:',
			'LOCALE_BLOCK'			=>	'Блокирование:',
			'LOCALE_REQUIRES'		=>	'Требует:',
			'LOCALE_REQUIRES_LEVEL'	=>	'Требуется уровень:',
			...
			'LOCALE_SECOND'    		=>  ' секунда',
			'LOCALE_SECONDS'    	=>  ' секунд',
			'LOCALE_MINUTE'    		=>  ' минута',
			'LOCALE_MINUTES'    	=>  ' минут',
			'LOCALE_SECOND_REMAINING'    =>  ' осталась секунда.',
			'LOCALE_SECONDS_REMAINING'   =>  ' осталось секунд.',
			'LOCALE_MINUTE_REMAINING'    =>  ' осталась минута.',
			'LOCALE_MINUTES_REMAINING'   =>  ' осталось минут.',
			'LOCALE_OF_MANA_BASE'   =>  '% базовой маны.',
			'LOCALE_MINUTES_CD'    	=>  ' минут до восстановления.',
			'LOCALE_SECONDS_CD'   	=>  ' секунд до восстановления.',
			'LOCALE_INSTANT'    	=>  'Мгновенное действие',
	...
	case '3':
		mass_define(array(
			...
			'LOCALE_NPCTYPE_DRANGONKIN' 		=> 'Dragonkin',
			...
			'LOCALE_QUEST_FLAGS_DELIVER_MORE'		=> 'Weitere Items benutzt',
			...
			'LOCALE_QUEST_FLAGS_REPEATABLE'			=> 'PvP',
			...
			'LOCALE_GBONUS_RESTOREHEALTH'		=>	'Restore %d health per 5 sec.',
			'LOCALE_GBONUS_SPELLPENETRATION'		=>	'Увеличивает проникающую способность заклинаний на %d.',
			'LOCALE_GBONUS_HIT_TAKEN_MELEE_RATING'	=>  'Erhöht Eure Ausweichwertung um %d.',
			'LOCALE_GBONUS_HIT_TAKEN_SPELL_RATING'	=>  'Improves spell hit avoidance rating by %d.',
			'LOCALE_GBONUS_HASTE_MELEE_RATING'		=>  'Improves melee haste rating by %d.',
			'LOCALE_GBONUS_RANGED_ATTACK_POWER' 	=>  'Increases ranged attack power by %d.',
	...
	case '2':
		mass_define(array(
			...
			'LOCALE_QUEST_FLAGS_DELIVER_MORE'		=> 'Les autres éléments utilisés',
			...
			'LOCALE_GBONUS_RESTOREHEALTH'		=>	'Restore %d health per 5 sec.',
			'LOCALE_GBONUS_SPELLPENETRATION'		=>	'Increases the penetrating ability of spells by %d.',
			'LOCALE_GBONUS_HIT_TAKEN_MELEE_RATING'	=>  'Augmente de %d le score d\'esquive.',
			'LOCALE_GBONUS_HIT_TAKEN_SPELL_RATING'	=>  'Improves spell hit avoidance rating by %d.',
			'LOCALE_GBONUS_HASTE_MELEE_RATING' 		=>  'Improves melee haste rating by %d.',
			'LOCALE_GBONUS_RANGED_ATTACK_POWER' 	=>  'Increases ranged attack power by %d.',
			'LOCALE_COOLDOWN'						=>	'cooldown',
	...
	default:
		mass_define(array(
			...
			// green bonuses
			'LOCALE_GBONUS_DEFENCE'				=>	'Defense rating + %d.',
			'LOCALE_GBONUS_DODGE'				=>	'Dodge rating + %d.',
			'LOCALE_GBONUS_PARRY'				=>	'Parry rating + %d.',
			'LOCALE_GBONUS_SHIELDBLOCK'			=>	'Shield block rating + %d.',
			'LOCALE_GBONUS_SPELLHIT_RATING'		=>	'Spell hit rating + %d.',
			'LOCALE_GBONUS_MELEECRIT_RATING'	=>	'Melee critical strike rating + %d.',
			'LOCALE_GBONUS_RANGEDCRIT_RATING'	=>	'Ranged critical strike rating + %d.',
			'LOCALE_GBONUS_SPELLCRIT_RATING'	=>	'Spell critical strike rating + %d.',
			'LOCALE_GBONUS_SPELLHASTE_RATING'	=>	'Spell haste rating + %d.',
			'LOCALE_GBONUS_HIT_RATING'			=>	'Hit rating + %d.',
			'LOCALE_GBONUS_CRIT_RATING'			=>	'Critical strike rating + %d.',
			'LOCALE_GBONUS_RESILIENCE_RATING'	=>	'Resilience rating + %d.',
			'LOCALE_GBONUS_HASTE_RATING'		=>	'Haste rating + %d.',
			'LOCALE_GBONUS_EXPERTISE_RATING'	=>	'Expertise rating + %d.',
			'LOCALE_GBONUS_RESTOREMANA'			=>	'Restores %d mana per 5 sec.',
			'LOCALE_GBONUS_ATTACKPOWER'			=>	'Attack power + %d.',
			'LOCALE_GBONUS_ARMORPENETRATION'	=>	'Armor penetration rating + %d.',
			'LOCALE_GBONUS_SPELLPOWER'			=>	'Spell power + %d.',
			...
			'LOCALE_GBONUS_RESTOREHEALTH'		=>	'Restore %d health per 5 sec.',
			'LOCALE_GBONUS_SPELLPENETRATION'		=>	'Penetrating ability of spells + %d.',
			'LOCALE_GBONUS_HIT_TAKEN_MELEE_RATING'	=>  'Dodge rating + %d.',
			'LOCALE_GBONUS_HIT_TAKEN_SPELL_RATING' =>  'Spell hit avoidance rating + %d.',
			'LOCALE_GBONUS_HASTE_MELEE_RATING' =>  'Melee haste rating + %d.',
			'LOCALE_GBONUS_RANGED_ATTACK_POWER' =>  'Ranged attack power + %d.',
			'LOCALE_COOLDOWN'						=>	'cooldown',
			'LOCALE_COMBAT_RATING'					=>	'%s&nbsp;@&nbsp;L%d',
			'LOCALE_SET_BONUS'						=>	'Set:',
			'LOCALE_ITEM_LVL'						=>	'Item Level ',
